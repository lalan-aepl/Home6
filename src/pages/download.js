    ...
    >
      <div className="text-white  bgstyles" >
        ...
        <div className="absolute left-[34rem] top-[6rem] xl:left-[68rem] xl:top-[7rem] lg:left-[38rem] xs-hidden">
          ...
          <div className="text-normalWhite rounded-full h-32 w-32 sm:h-48 sm:w-48 bg-circle-2 flex flex-col p-2 items-center text-center">
        ...
        <div className="absolute left-[34rem] top-[0rem] xl:left-[57rem] xl:top-[-12rem] lg:left-[38rem]">
          <Image src={phone} alt="phone-gif" className="absolute hidden sm:block xl:block xl:right-0 xl:top-0 xl:mt-4 xl:w-full" />
        </div>
      </div>
    </section>
  );
