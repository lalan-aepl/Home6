    ...
    <div className='bg-normalWhite pt-4'>
        <div className='px-4 sm:px-20 max-w-screen-2xl mx-auto p-2'>
            ...
            <div className='grid grid-flow-row sm:grid-cols-2 grid-cols-1 pt-3  lg:gap-10 sm:gap-6 gap-6'>
                ...
                <WhatWeOfferCard icon={<PlagiarismOutlinedIcon/>} title='Refundable' msg="aeccusamus etmaes iusto odiomae dignissimos ducimus quistames blanditiis praesentium voluptatum loramkes anuten." /> 
                <WhatWeOfferCard icon={<MonetizationOnOutlinedIcon/>} title='Compatative Pricing' msg="aeccusamus etmaes iusto odiomae dignissimos ducimus quistames blanditiis praesentium voluptatum loramkes anuten." /> 
                <WhatWeOfferCard icon={<AutorenewOutlinedIcon/>} title='Unlimited Revissions' msg="aeccusamus etmaes iusto odiomae dignissimos ducimus quistames blanditiis praesentium voluptatum loramkes anuten." /> 
